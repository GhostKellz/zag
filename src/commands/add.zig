...
pub fn add(allocator: Allocator, package_ref: []const u8) !void {
    ...
    try modifyBuildZig(allocator, package_name, deps_path);
...
fn modifyBuildZig(allocator: Allocator, package_name: []const u8, deps_path: []const u8) !void {
    ...
    const injection_marker = "// zag:deps - dependencies will be added below this line";
...
/// Inject dependency after the zag:deps marker
...
fn injectAtBestLocation(allocator: Allocator, content: []const u8, package_name: []const u8, deps_path: []const u8) !void {
    ...
    if (injection_pos) |pos| {
        ...
        std.debug.print("💡 Add this line to your build.zig: // zag:deps - dependencies will be added below this line\n", .{});
    }
}
